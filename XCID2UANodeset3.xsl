...
<!-- Aux Templates-->
  ...
  <xsl:template name="ProcessLN">
    ...
    <UAObject>
		...
		<xsl:element name="DisplayName"><xsl:value-of select="$PLN"/><xsl:value-of select="@name"/></xsl:element>
          ...
          -->
			...
			<xsl:for-each select="current-group()">
                ...
                -->
                  ...
                  -->
							...
							<!--<xsl:message>Create setMag variable for APC CDC</xsl:message>-->								
								<xsl:element name="UAVariable" >
									<xsl:attribute name="NodeId">ns=1;s=<xsl:value-of select="@ldInst"/>/<xsl:value-of select="@prefix"/><xsl:value-of select="@lnClass"/><xsl:value-of select="@lnInst"/>.<xsl:value-of select="@doName"/>.setMag</xsl:attribute>
									<xsl:attribute name="BrowseName">1:<xsl:value-of select="@ldInst"/>/<xsl:value-of select="@prefix"/><xsl:value-of select="@lnClass"/><xsl:value-of select="@lnInst"/>.<xsl:value-of select="@doName"/>.setMag</xsl:attribute>
									<xsl:attribute name="DataType">i=1</xsl:attribute>
									<xsl:element name="DisplayName"><xsl:value-of select="@ldInst"/>/<xsl:value-of select="@prefix"/><xsl:value-of select="@lnClass"/><xsl:value-of select="@lnInst"/>.<xsl:value-of select="@doName"/>.setMag</xsl:element>
									<xsl:element name="Description"><xsl:value-of select="@desc"/></xsl:element>
									<References>
									  <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
									  <Reference ReferenceType="HasProperty" IsForward="false">ns=1;s=<xsl:value-of select="@ldInst"/>/<xsl:value-of select="@prefix"/><xsl:value-of select="@lnClass"/><xsl:value-of select="@lnInst"/>.<xsl:value-of select="@doName"/></Reference>
                  ...
                  -->
							...
							<!--<xsl:message>Create mxVal variable for BAC CDC</xsl:message>-->
								<xsl:element name="UAVariable" >
									<xsl:attribute name="NodeId">ns=1;s=<xsl:value-of select="@ldInst"/>/<xsl:value-of select="@prefix"/><xsl:value-of select="@lnClass"/><xsl:value-of select="@lnInst"/>.<xsl:value-of select="@doName"/>.mxVal</xsl:attribute>
									<xsl:attribute name="BrowseName">1:<xsl:value-of select="@ldInst"/>/<xsl:value-of select="@prefix"/><xsl:value-of select="@lnClass"/><xsl:value-of select="@lnInst"/>.<xsl:value-of select="@doName"/>.mxVal</xsl:attribute>
									<xsl:attribute name="DataType">i=7</xsl:attribute>
									<xsl:element name="DisplayName"><xsl:value-of select="@ldInst"/>/<xsl:value-of select="@prefix"/><xsl:value-of select="@lnClass"/><xsl:value-of select="@lnInst"/>.<xsl:value-of select="@doName"/>.mxVal</xsl:element>
									<xsl:element name="Description"><xsl:value-of select="@desc"/></xsl:element>
									<References>
									  <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
									  <Reference ReferenceType="HasProperty" IsForward="false">ns=1;s=<xsl:value-of select="@ldInst"/>/<xsl:value-of select="@prefix"/><xsl:value-of select="@lnClass"/><xsl:value-of select="@lnInst"/>.<xsl:value-of select="@doName"/></Reference>
                  ...
                  -->
							...
							<!--<xsl:message>Create instVal variable for SAV CDC</xsl:message>-->												
								<xsl:element name="UAVariable" >
									<xsl:attribute name="NodeId">ns=1;s=<xsl:value-of select="@ldInst"/>/<xsl:value-of select="@prefix"/><xsl:value-of select="@lnClass"/><xsl:value-of select="@lnInst"/>.<xsl:value-of select="@doName"/>.instVal</xsl:attribute>
									<xsl:attribute name="BrowseName">1:<xsl:value-of select="@ldInst"/>/<xsl:value-of select="@prefix"/><xsl:value-of select="@lnClass"/><xsl:value-of select="@lnInst"/>.<xsl:value-of select="@doName"/>.instVal</xsl:attribute>
									<xsl:attribute name="DataType">i=7</xsl:attribute>
									<xsl:element name="DisplayName"><xsl:value-of select="@ldInst"/>/<xsl:value-of select="@prefix"/><xsl:value-of select="@lnClass"/><xsl:value-of select="@lnInst"/>.<xsl:value-of select="@doName"/>.instVal</xsl:element>
									<xsl:element name="Description"><xsl:value-of select="@desc"/></xsl:element>
									<References>
									  <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
									  <Reference ReferenceType="HasProperty" IsForward="false">ns=1;s=<xsl:value-of select="@ldInst"/>/<xsl:value-of select="@prefix"/><xsl:value-of select="@lnClass"/><xsl:value-of select="@lnInst"/>.<xsl:value-of select="@doName"/></Reference>
                  ...
                  -->
							...
							<!--<xsl:message>Create seqT variable for SAV CDC</xsl:message>-->										
								<xsl:element name="UAVariable" >
									<xsl:attribute name="NodeId">ns=1;s=<xsl:value-of select="@ldInst"/>/<xsl:value-of select="@prefix"/><xsl:value-of select="@lnClass"/><xsl:value-of select="@lnInst"/>.<xsl:value-of select="@doName"/>.seqT</xsl:attribute>
									<xsl:attribute name="BrowseName">1:<xsl:value-of select="@ldInst"/>/<xsl:value-of select="@prefix"/><xsl:value-of select="@lnClass"/><xsl:value-of select="@lnInst"/>.<xsl:value-of select="@doName"/>.seqT</xsl:attribute>
									<xsl:attribute name="DataType">i=7</xsl:attribute>
									<xsl:element name="DisplayName"><xsl:value-of select="@ldInst"/>/<xsl:value-of select="@prefix"/><xsl:value-of select="@lnClass"/><xsl:value-of select="@lnInst"/>.<xsl:value-of select="@doName"/>.seqT</xsl:element>
									<xsl:element name="Description"><xsl:value-of select="@desc"/></xsl:element>
									<References>
									<Reference ReferenceType="HasTypeDefinition">i=68</Reference>
									<Reference ReferenceType="HasProperty" IsForward="false">ns=1;s=<xsl:value-of select="@ldInst"/>/<xsl:value-of select="@prefix"/><xsl:value-of select="@lnClass"/><xsl:value-of select="@lnInst"/>.<xsl:value-of select="@doName"/></Reference>
                ...
                -->
                  ...
                  -->
							...
							<!--<xsl:message>Create .valWTr DA variable for BSC CDC with ST FC</xsl:message>-->
								...
								<xsl:attribute name="DataType">String</xsl:attribute>
								<xsl:element name="DisplayName">valWTr DA</xsl:element>
								<xsl:element name="Description">Status Value Data Attribute variable</xsl:element>
								<References>
								  <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
								  <Reference ReferenceType="HasProperty" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></Reference>
                ...
                <!--<xsl:message>Create .actVal DA variable for BCR CDC with ST FC</xsl:message>-->
								...
								<xsl:attribute name="DataType">String</xsl:attribute>
								<xsl:element name="DisplayName">actVal DA</xsl:element>
								<xsl:element name="Description">Status Value Data Attribute variable</xsl:element>
								<References>
								  <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
								  <Reference ReferenceType="HasProperty" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></Reference>
                ...
                -->
							...
							<!--<xsl:message>Create .frVal DA variable for BCR CDC with ST FC</xsl:message>-->
								...
								<xsl:attribute name="DataType">String</xsl:attribute>
								<xsl:element name="DisplayName">frVal DA</xsl:element>
								<xsl:element name="Description">Status Value Data Attribute variable</xsl:element>
								<References>
								  <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
								  <Reference ReferenceType="HasProperty" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></Reference>
                ...
                -->
						...
						<xsl:when test="@doName=&apos;AuthFail&apos;
							...
							<!--<xsl:message>Create cnt DA variable for SEC CDC with ST FC</xsl:message>-->
								...
								<xsl:element name="DisplayName">cnt DA</xsl:element>
								<xsl:element name="Description">Status Value Data Attribute variable</xsl:element>
								<References>
								  <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
								  <Reference ReferenceType="HasProperty" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></Reference>
                ...
                -->
							...
							<xsl:element name="UAVariable" >
								...
								<xsl:attribute name="DataType">i=7</xsl:attribute>
								<xsl:element name="DisplayName">sev DA</xsl:element>
								<xsl:element name="Description">Status Value Data Attribute variable</xsl:element>
								<References>
								  <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
								  <Reference ReferenceType="HasProperty" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></Reference>
                ...
                -->
							...
							<xsl:element name="UAVariable" >
								...
								<xsl:attribute name="DataType">i=7</xsl:attribute>
								<xsl:element name="DisplayName">addr DA</xsl:element>
								<xsl:element name="Description">Status Value Data Attribute variable</xsl:element>
								<References>
								  <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
								  <Reference ReferenceType="HasProperty" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></Reference>
                ...
                -->
							...
							<xsl:element name="UAVariable" >
								...
								<xsl:attribute name="DataType">i=12</xsl:attribute>
								<xsl:element name="DisplayName">addInfo DA</xsl:element>
								<xsl:element name="Description">Status Value Data Attribute variable</xsl:element>
								<References>
								  <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
								  <Reference ReferenceType="HasProperty" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></Reference>
