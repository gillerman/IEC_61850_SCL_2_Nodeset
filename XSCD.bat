...
@echo off
rem    %xslproc1% Example61850TestSCD.xml XSCL2UANodeset3.xsl -o IEC_61850_SCD_UANodeset3.xml
    %xslproc2% Example61850TestSCD.xml XSCL2UANodeset3.xsl > IEC_61850_SCD_UANodeset3.xml
rem    %xslproc3% Example61850TestSCD.xml XSCL2UANodeset3.xsl IEC_61850_SCD_UANodeset3.xml
