      ...
      <xsl:for-each select="nsSCL:LDevice">
        ...
        <xsl:for-each select="nsSCL:LN0">
              ...
              <Reference ReferenceType="Organizes" IsForward="false">ns=1;s=LNs</Reference>
							<Reference ReferenceType="HasTypeDefinition">ns=1;s=BaseLN</Reference>
						</References>
					</UAObject>   
      ...
      <!--<xsl:message>For DS <xsl:value-of select="../@name"/>, create objects for <xsl:value-of select="@doName"/> DO with <xsl:value-of select="@fc"/> FC for LN <xsl:value-of select="$PLN"/></xsl:message>-->
        ...
        <xsl:attribute name="NodeId">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></xsl:attribute>
				...
				<References>
					<Reference ReferenceType="HasComponent" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="../@name"/></Reference>
          <Reference ReferenceType="Organizes" IsForward="false">ns=1;s=DOs</Reference>
          <Reference ReferenceType="HasTypeDefinition">ns=1;s=<xsl:value-of select="@doName"/></Reference>
				</References>
			</UAObject>
			  ...
			  <xsl:for-each select="current-group()">
					...
					<xsl:when test="@doName=&apos;A&apos;
						...
						<!--<xsl:message>Create CVMs for WYE CDC</xsl:message>-->
							<xsl:call-template name="CMV"><xsl:with-param name="PPLN"><xsl:value-of select="$PLN"/></xsl:with-param><xsl:with-param name="PSDO"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@doName"/>.phsA</xsl:with-param></xsl:call-template>
							<xsl:call-template name="CMV"><xsl:with-param name="PPLN"><xsl:value-of select="$PLN"/></xsl:with-param><xsl:with-param name="PSDO"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@doName"/>.phsB</xsl:with-param></xsl:call-template>							
							<xsl:call-template name="CMV"><xsl:with-param name="PPLN"><xsl:value-of select="$PLN"/></xsl:with-param><xsl:with-param name="PSDO"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@doName"/>.phsC</xsl:with-param></xsl:call-template>
							<xsl:call-template name="CMV"><xsl:with-param name="PPLN"><xsl:value-of select="$PLN"/></xsl:with-param><xsl:with-param name="PSDO"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@doName"/>.neut</xsl:with-param></xsl:call-template>							
							<xsl:call-template name="CMV"><xsl:with-param name="PPLN"><xsl:value-of select="$PLN"/></xsl:with-param><xsl:with-param name="PSDO"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@doName"/>.net</xsl:with-param></xsl:call-template>
							<xsl:call-template name="CMV"><xsl:with-param name="PPLN"><xsl:value-of select="$PLN"/></xsl:with-param><xsl:with-param name="PSDO"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@doName"/>.res</xsl:with-param></xsl:call-template>
						</xsl:when>
						...
						<!--<xsl:message>Create CVM for CMV CDC</xsl:message>-->
							<xsl:call-template name="CMV"><xsl:with-param name="PPLN"></xsl:with-param><xsl:with-param name="PSDO"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@doName"/></xsl:with-param></xsl:call-template>
						</xsl:when>	
                ...
                <!--<xsl:message>Create CVMs for DEL CDC</xsl:message>-->
								<xsl:call-template name="CMV"><xsl:with-param name="PPLN"><xsl:value-of select="$PLN"/></xsl:with-param><xsl:with-param name="PSDO"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@doName"/>.phsAB</xsl:with-param></xsl:call-template>
								<xsl:call-template name="CMV"><xsl:with-param name="PPLN"><xsl:value-of select="$PLN"/></xsl:with-param><xsl:with-param name="PSDO"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@doName"/>.phsBC</xsl:with-param></xsl:call-template>							
								<xsl:call-template name="CMV"><xsl:with-param name="PPLN"><xsl:value-of select="$PLN"/></xsl:with-param><xsl:with-param name="PSDO"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@doName"/>.phsCA</xsl:with-param></xsl:call-template>
						</xsl:when>
              ...
              <!--<xsl:message>Create DA variable for MV CDC with MX FC</xsl:message>-->
							<xsl:element name="UAVariable">
                <!--<xsl:message>Create mag DA object</xsl:message>-->
								<xsl:attribute name="NodeId">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.mag</xsl:attribute>
								<xsl:attribute name="BrowseName">1:<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.mag</xsl:attribute>
								<xsl:attribute name="DataType">ns=1;s=magDT</xsl:attribute>
                <xsl:element name="DisplayName"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.<xsl:value-of select="@daName"/>mag DA</xsl:element>
								<xsl:element name="Description">Magnitude Data Attribute object</xsl:element>
								<References>
									<Reference ReferenceType="HasTypeDefinition">ns=1;s=magVT</Reference>
                ...
                <!--<xsl:message>Create integer mag variable</xsl:message>-->
								<xsl:attribute name="NodeId">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.mag.i</xsl:attribute>
								<xsl:attribute name="BrowseName">1:<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.mag.i</xsl:attribute>
								<xsl:attribute name="DataType">ns=1;s=bTypeInt32</xsl:attribute>
								<xsl:element name="DisplayName"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.mag.i DA</xsl:element>
								<xsl:element name="Description">Magnitude.Integer value Data Attribute variable</xsl:element>
								<References>
								  <Reference ReferenceType="HasTypeDefinition">ns=1;s=magDT</Reference>
								  <Reference ReferenceType="HasComponent" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.mag</Reference>
								  <Reference ReferenceType="Organizes" IsForward="false">ns=1;s=DAs</Reference>
                ...
                <xsl:with-param name="PDO"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></xsl:with-param>
							...
							<!--<xsl:message>Create orCat variable for APC CDC</xsl:message>-->		
								<xsl:element name="UAVariable">
									...
									<References>
									<Reference ReferenceType="HasTypeDefinition">i=63</Reference>
									<Reference ReferenceType="HasComponent" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.origin</Reference>
									<Reference ReferenceType="Organizes" IsForward="false">ns=1;s=DAs</Reference>
									<!--<Reference ReferenceType="HasProperty" IsForward="false">ns=1;s=MX</Reference>-->
                  ...
                  -->
							...
							<!--<xsl:message>Create ctlNum variable for BAC CDC</xsl:message>-->	
								<xsl:element name="UAVariable">
									...
									<xsl:attribute name="DataType">ns=1;s=bTypeInt8U</xsl:attribute>
									...
									<xsl:element name="Description"><xsl:value-of select="@desc"/>BAC Control Number Data Attribute variable</xsl:element>
									<References>
									  <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
									  <Reference ReferenceType="HasComponent" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></Reference>
									  <Reference ReferenceType="Organizes" IsForward="false">ns=1;s=DAs</Reference>
                  ...
                  <xsl:with-param name="PDO"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></xsl:with-param>
							...
							<!--<xsl:message>Create ctlNum variable for RST CDC</xsl:message>-->	
								<xsl:element name="UAVariable">
									...
									<xsl:attribute name="DataType">ns=1;s=bTypeInt8U</xsl:attribute>
									<xsl:element name="DisplayName"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.ctlNum</xsl:element>
									<xsl:element name="Description"><xsl:value-of select="@desc"/>RST Control Number Data Attribute variable</xsl:element>
									<References>
									<Reference ReferenceType="HasTypeDefinition">i=68</Reference>
									<Reference ReferenceType="HasComponent" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></Reference>
									<Reference ReferenceType="Organizes" IsForward="false">ns=1;s=DAs</Reference>
                  ...
                  <xsl:with-param name="PDO"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></xsl:with-param>
							...
							<xsl:when test="@doName=&apos;SeqA&apos;
								...
								or	@doName=&apos;DQ0Seq&apos;">
									...
									<xsl:call-template name="CMV"><xsl:with-param name="PPLN"><xsl:value-of select="$PLN"/></xsl:with-param><xsl:with-param name="PSDO"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@doName"/>.C1</xsl:with-param></xsl:call-template>
									<xsl:call-template name="CMV"><xsl:with-param name="PPLN"><xsl:value-of select="$PLN"/></xsl:with-param><xsl:with-param name="PSDO"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@doName"/>.C2</xsl:with-param></xsl:call-template>							
									<xsl:call-template name="CMV"><xsl:with-param name="PPLN"><xsl:value-of select="$PLN"/></xsl:with-param><xsl:with-param name="PSDO"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@doName"/>.C3</xsl:with-param></xsl:call-template>
              ...
              <xsl:call-template name="Quality">
                ...
                -->
							...
							<xsl:element name="UAVariable">
								...
								<xsl:element name="Description"><xsl:value-of select="@desc"/>DPC Control Number Data Attribute variable</xsl:element>
								<References>
								  <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
								  <Reference ReferenceType="HasComponent" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></Reference>
								  <Reference ReferenceType="Organizes" IsForward="false">ns=1;s=DAs</Reference>
                ...
                -->
							...
							<xsl:element name="UAVariable">
								...
								<xsl:element name="Description">DPC DpStatusKind Status Value Data Attribute variable</xsl:element>
								<References>
								<Reference ReferenceType="HasTypeDefinition">i=68</Reference>
								<Reference ReferenceType="HasComponent" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></Reference>
								<Reference ReferenceType="Organizes" IsForward="false">ns=1;s=DAs</Reference>
                ...
                <xsl:with-param name="PDO"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></xsl:with-param>
						...
						<xsl:when test="@doName=&apos;Mod&apos;
							...
							or @doName=&apos;OpModSyn&apos;">	
							<xsl:element name="UAVariable">
                <!--<xsl:message>Create origin DA variables for ENC CDC with ST FC</xsl:message>-->
								<xsl:attribute name="NodeId">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.origin</xsl:attribute>
								<xsl:attribute name="BrowseName">1:<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.origin</xsl:attribute>
								<xsl:element name="DisplayName"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.origin DA</xsl:element>
								<xsl:element name="Description">Originator Data Attribute variable</xsl:element>
                ...
                -->
							...
							<xsl:element name="UAVariable">
								<xsl:attribute name="NodeId">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.ctlModel</xsl:attribute>
								<xsl:attribute name="BrowseName">1:<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.ctlModel</xsl:attribute>
								<xsl:attribute name="DataType">ns=1;s=bTypeInt8U</xsl:attribute>
								<xsl:element name="DisplayName"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.ctlModel DA</xsl:element>
								<xsl:element name="Description">ENC Control Model Data Attribute variable</xsl:element>
								<References>
								  <Reference ReferenceType="HasTypeDefinition">ns=1;s=ctlModelVT</Reference>
								  <Reference ReferenceType="HasComponent" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></Reference>
								  <Reference ReferenceType="Organizes" IsForward="false">ns=1;s=DAs</Reference>
								  <!--<Reference ReferenceType="HasProperty" IsForward="false">ns=1;s=ST</Reference>-->
								</References>
                ...
                -->
							...
							<xsl:element name="UAVariable">
								...
								<xsl:element name="DisplayName"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.stVal DA</xsl:element>
								<xsl:element name="Description">ENC EnumDA (Mod) Status Value Data Attribute variable</xsl:element>
								<References>
								  <Reference ReferenceType="HasTypeDefinition">ns=1;s=stValVT</Reference>
								  <Reference ReferenceType="HasComponent" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></Reference>
								  <Reference ReferenceType="Organizes" IsForward="false">ns=1;s=DAs</Reference>
								  <!--<Reference ReferenceType="HasProperty" IsForward="false">ns=1;s=ST</Reference>-->
								</References>
                ...
                <xsl:with-param name="PDO"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></xsl:with-param>
						...
						<!--<xsl:message>Create DA variables for ENS CDC with ST FC</xsl:message>-->				
						  <xsl:if test="@daName=&apos;stVal&apos;">
                <xsl:element name="UAVariable">
								  <xsl:attribute name="NodeId">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.stVal</xsl:attribute>
								  <xsl:attribute name="BrowseName">1:<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.stVal</xsl:attribute>
								  <xsl:attribute name="DataType">ns=1;s=bTypeInt32U</xsl:attribute>
								  <xsl:element name="DisplayName"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.stVal DA</xsl:element>
								  <xsl:element name="Description">ENS EnumDA (Beh, Health, AutoRecSt) Status Value Data Attribute variable</xsl:element>
								  <References>
								    <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
								    <Reference ReferenceType="HasComponent" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></Reference>
								    <Reference ReferenceType="Organizes" IsForward="false">ns=1;s=DAs</Reference>
              ...
              <xsl:if test="@daName=&apos;q&apos;">
                ...
                <xsl:with-param name="PDO"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></xsl:with-param>
						...
						<xsl:when test="contains(@doName,&apos;Ind1&apos;)
              ...
              <!--<xsl:message>Create .stVal DA variable for SPS CDC with ST FC</xsl:message>-->
                ...
                <xsl:element name="UAVariable">
								  ...
								  <xsl:element name="DisplayName"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.stVal DA</xsl:element>
								  <xsl:element name="Description">SPS (Ind_D, etc.) Status Value Data Attribute variable</xsl:element>
								  <References>
								    <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
								    <Reference ReferenceType="HasComponent" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></Reference>
								    <Reference ReferenceType="Organizes" IsForward="false">ns=1;s=DAs</Reference>
            ...
            <!--DOs with generic CDC SPS-Single point status-->
              ...
              <!--<xsl:message>Create .stVal DA variable for SPS CDC with ST FC</xsl:message>-->
                ...
                <xsl:element name="UAVariable">
								  ...
								  <xsl:attribute name="DataType">ns=1;s=bTypeBOOLEAN</xsl:attribute>
								  <xsl:element name="DisplayName"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.stVal DA</xsl:element>
								  <xsl:element name="Description">SPS (Alm, etc.) Status Value Data Attribute variable</xsl:element>
								  <References>
								    <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
								    <Reference ReferenceType="HasComponent" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></Reference>
								    <Reference ReferenceType="Organizes" IsForward="false">ns=1;s=DAs</Reference>
              ...
              <xsl:if test="@daName=&apos;q&apos;">
                ...
                <!--<xsl:message>Create .stVal DA variable for SPS CDC with ST FC</xsl:message>-->
								...
								<xsl:attribute name="DataType">ns=1;s=bTypeBOOLEAN</xsl:attribute>
								<xsl:element name="DisplayName"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.stVal DA</xsl:element>
								<xsl:element name="Description">SPS Status Value Data Attribute variable</xsl:element>
								<References>
								  <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
								  <Reference ReferenceType="HasComponent" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></Reference>
								  <Reference ReferenceType="Organizes" IsForward="false">ns=1;s=DAs</Reference>
            ...
            <xsl:when test="@fc=&apos;ST&apos; 
							and	(@doName=&apos;Pos&apos;)">
							<xsl:element name="UAVariable">
                <!--<xsl:message>Create origin DA variables for DPC CDC with ST FC</xsl:message>-->
								<xsl:attribute name="NodeId">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.origin</xsl:attribute>
								<xsl:attribute name="BrowseName">1:<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.origin</xsl:attribute>
								<xsl:element name="DisplayName"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.origin DA</xsl:element>
								<xsl:element name="Description">Originator Data Attribute variable</xsl:element>
                ...
                -->
							...
							<xsl:element name="UAVariable">
								...
								<xsl:attribute name="DataType">ns=1;s=bTypeDbpos</xsl:attribute>
								<xsl:element name="DisplayName"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.stVal DA</xsl:element>
								<xsl:element name="Description">DPC (pos) Status Value Data Attribute variable</xsl:element>
								<References>
								  <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
								  <Reference ReferenceType="HasComponent" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></Reference>
								  <Reference ReferenceType="Organizes" IsForward="false">ns=1;s=DAs</Reference>
                ...
                -->
							...
							<xsl:element name="UAVariable">
								...
								<References>
								  <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
								  <Reference ReferenceType="HasProperty" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.origin</Reference>
								  <Reference ReferenceType="HasComponent" IsForward="false">ns=1;s=DAs</Reference>
								  <!--<Reference ReferenceType="HasProperty" IsForward="false">ns=1;s=ST</Reference>-->
								</References>
                <!--
								<Value>
                ...
                -->
							...
							<xsl:element name="UAVariable">
								...
								<xsl:attribute name="DataType">ns=1;s=bTypeInt8U</xsl:attribute>
								<xsl:element name="DisplayName"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.ctlNum DA</xsl:element>
								<xsl:element name="Description"><xsl:value-of select="@desc"/>SPC Control Number Data Attribute variable</xsl:element>
								<References>
								  <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
								  <Reference ReferenceType="HasComponent" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></Reference>
								  <Reference ReferenceType="Organizes" IsForward="false">ns=1;s=DAs</Reference>
                ...
                -->
							...
							<xsl:element name="UAVariable">
								...
								<xsl:attribute name="DataType">i=7</xsl:attribute>
								<xsl:element name="DisplayName"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.stVal DA</xsl:element>
								<xsl:element name="Description">SPC (BlkOpen, BlkCls) Status Value Data Attribute variable</xsl:element>
								<References>
								  <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
								  <Reference ReferenceType="HasComponent" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></Reference>
								  <Reference ReferenceType="Organizes" IsForward="false">ns=1;s=DAs</Reference>
              ...
              <xsl:element name="UAVariable">
                ...
                -->
							...
							<xsl:element name="UAVariable">
								...
								<xsl:attribute name="DataType">ns=1;s=bTypeInt8U</xsl:attribute>
								<xsl:element name="DisplayName"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.ctlNum DA</xsl:element>
								<xsl:element name="Description">INC Control Number Data Attribute variable</xsl:element>
								<References>
								  <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
								  <Reference ReferenceType="HasComponent" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></Reference>
								  <Reference ReferenceType="Organizes" IsForward="false">ns=1;s=DAs</Reference>
                ...
                -->
							...
							<xsl:element name="UAVariable">
								...
								<xsl:attribute name="DataType">ns=1;s=bTypeInt32U</xsl:attribute>
								<xsl:element name="DisplayName"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.stVal DA</xsl:element>
								<xsl:element name="Description">INC Mod Status Value Data Attribute variable</xsl:element>
								<References>
								  <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
								  <Reference ReferenceType="HasComponent" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></Reference>
								  <Reference ReferenceType="Organizes" IsForward="false">ns=1;s=DAs</Reference>
                ...
                <xsl:element name="UAVariable">
								  ...
								  <xsl:attribute name="DataType">ns=1;s=bTypeInt32U</xsl:attribute>
								  <xsl:element name="DisplayName"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.stVal DA</xsl:element>
								  <xsl:element name="Description">INS (Beh) Status Value Data Attribute variable</xsl:element>
								  <References>
								    <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
								    <Reference ReferenceType="HasComponent" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></Reference>
								    <Reference ReferenceType="Organizes" IsForward="false">ns=1;s=DAs</Reference>
                ...
                <xsl:with-param name="PDO"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></xsl:with-param>
						...
						<xsl:when test="@fc=&apos;ST&apos; 
							...
							<!--<xsl:message>Create .stVal DA variable for BSC CDC with ST FC</xsl:message>-->
								...
								<xsl:attribute name="DataType">ns=1;s=bTypeBOOLEAN</xsl:attribute>
								<xsl:element name="DisplayName"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.stVal DA</xsl:element>
								<xsl:element name="Description">BSC (TabChg, PosChg) Status Value Data Attribute variable</xsl:element>
								<References>
								  <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
								  <Reference ReferenceType="HasComponent" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></Reference>
								  <Reference ReferenceType="Organizes" IsForward="false">ns=1;s=DAs</Reference>
                  ...
                  -->
							...
							<!--<xsl:message>Create ctlNum variable for ISC CDC</xsl:message>-->	
								<xsl:element name="UAVariable">
									...
									<xsl:attribute name="DataType">ns=1;s=bTypeInt8U</xsl:attribute>
									<xsl:element name="DisplayName"><xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/>.ctlNum</xsl:element>
									<xsl:element name="Description"><xsl:value-of select="@desc"/>ISC Control Number Data Attribute variable</xsl:element>
									<References>
									  <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
									  <Reference ReferenceType="HasComponent" IsForward="false">ns=1;s=<xsl:value-of select="$PLN"/>.<xsl:value-of select="@fc"/>.<xsl:value-of select="@doName"/></Reference>
									  <Reference ReferenceType="Organizes" IsForward="false">ns=1;s=DAs</Reference>
...
-->  
  <xsl:template name="CMV">
    <xsl:param name="PPLN"/>
		<xsl:param name="PSDO"/>
		<xsl:if test="$PPLN!=&apos;&apos;">
      <!-- If Complex Measured Value CDC, then don't create the SDO Variable -->
			<UAVariable>
				<xsl:attribute name="NodeId">ns=1;s=<xsl:value-of select="$PSDO"/></xsl:attribute>
				<xsl:attribute name="BrowseName">1:<xsl:value-of select="$PSDO"/></xsl:attribute>
        <xsl:attribute name="DataType">ns=1;s=CMVDT</xsl:attribute>
				<xsl:element name="DisplayName"><xsl:value-of select="$PSDO"/> SDO </xsl:element>
				<xsl:element name="Description"><xsl:value-of select="$PSDO"/> Sub Data Object variable</xsl:element>
        <xsl:message>SDO Description1: <xsl:sequence select="fn:string($PSDO/@desc)"/></xsl:message>
        <xsl:message>SDO Description2: <xsl:value-of select="$PSDO/@desc"/></xsl:message>
				<References>
				  <Reference ReferenceType="HasTypeDefinition">ns=1;s=<xsl:value-of select="$PSDO"/>VT</Reference>
          <Reference ReferenceType="HasComponent" IsForward="false">ns=1;s=<xsl:value-of select="$PPLN"/>.<xsl:value-of select="@doName"/></Reference>
					<Reference ReferenceType="Organizes" IsForward="false">ns=1;s=SDOs</Reference>
        </References>
			</UAVariable>
		</xsl:if>
		<UAVariable>
			<xsl:attribute name="NodeId">ns=1;s=<xsl:value-of select="$PSDO"/>.cVal</xsl:attribute>
			<xsl:attribute name="BrowseName">1:<xsl:value-of select="$PSDO"/>.cVal</xsl:attribute>
      <xsl:attribute name="DataType">String</xsl:attribute>
			<xsl:element name="DisplayName"><xsl:value-of select="$PSDO"/>.cVal DA</xsl:element>
			<xsl:element name="Description"><xsl:value-of select="$PSDO"/> Deadbanded complex value Data Attribute variable</xsl:element>
			<References>
				<Reference ReferenceType="HasTypeDefinition">ns=1;s=<xsl:value-of select="$PSDO"/>.cValVT</Reference>
				<Reference ReferenceType="HasComponent" IsForward="false">ns=1;s=<xsl:value-of select="$PSDO"/></Reference>
				<Reference ReferenceType="Organizes" IsForward="false">ns=1;s=SDOs</Reference>
      </References>
		</UAVariable>
		<UAVariable>
			<xsl:attribute name="NodeId">ns=1;s=<xsl:value-of select="$PSDO"/>.cVal.mag</xsl:attribute>
			<xsl:attribute name="BrowseName">1:<xsl:value-of select="$PSDO"/>.cVal.mag</xsl:attribute>
      <xsl:attribute name="DataType">String</xsl:attribute>
			<xsl:element name="DisplayName"><xsl:value-of select="$PSDO"/>.cVal.mag DA</xsl:element>
			<xsl:element name="Description"><xsl:value-of select="$PSDO"/> Deadbanded complex value magnitude Data Attribute variable</xsl:element>
			<References>
				<Reference ReferenceType="HasTypeDefinition">i=68</Reference>
        <Reference ReferenceType="HasComponent" IsForward="false">ns=1;s=<xsl:value-of select="$PSDO"/>.cVal</Reference>
			</References>
		</UAVariable>
		<UAVariable>
			<xsl:attribute name="NodeId">ns=1;s=<xsl:value-of select="$PSDO"/>.cVal.mag.i</xsl:attribute>
			<xsl:attribute name="BrowseName">1:<xsl:value-of select="$PSDO"/>.cVal.mag.i</xsl:attribute>
			<xsl:attribute name="DataType">String</xsl:attribute>
			<xsl:element name="DisplayName"><xsl:value-of select="$PSDO"/>.cVal.mag.i</xsl:element>
			<xsl:element name="Description"> Deadbanded complex value magnitude integer value Data Attribute variable</xsl:element>
			<References>
			  <Reference ReferenceType="HasTypeDefinition">i=68</Reference>
			  <Reference ReferenceType="HasProperty" IsForward="false">ns=1;s=<xsl:value-of select="$PSDO"/>.cVal.mag</Reference>
			</References>
      <!--
			<Value>
			  <String/>
      ...
      -->
		...
		<UAVariable>
			<xsl:attribute name="NodeId">ns=1;s=<xsl:value-of select="$PSDO"/>.cVal.mag.f</xsl:attribute>
			<xsl:attribute name="BrowseName">1:<xsl:value-of select="$PSDO"/>.cVal.mag.f</xsl:attribute>
			<xsl:attribute name="DataType">String</xsl:attribute>
			<xsl:element name="DisplayName"><xsl:value-of select="$PSDO"/>.cVal.mag.f</xsl:element>
...
-->  
  ...
  <xsl:template name="Quality">
    ...
    <!--<xsl:message>Create quality variable</xsl:message>-->
		<xsl:attribute name="NodeId">ns=1;s=<xsl:value-of select="$PDO"/>.q</xsl:attribute>
		<xsl:attribute name="BrowseName">1:<xsl:value-of select="$PDO"/>.q</xsl:attribute>
		<xsl:attribute name="DataType">String</xsl:attribute>
		<xsl:element name="DisplayName">q DA</xsl:element>
		<xsl:element name="Description">Quality Data Attribute variable</xsl:element>
		<References>
			<Reference ReferenceType="HasTypeDefinition">i=68</Reference>
			<Reference ReferenceType="HasProperty" IsForward="false">ns=1;s=<xsl:value-of select="$PDO"/></Reference>
		</References>
		</UAVariable>
  </xsl:template>
  ...
  <xsl:template name="Time">
    <xsl:param name="PDO"/>
      ...
      <!--<xsl:message>Create timestamp variable</xsl:message>-->
			<xsl:attribute name="NodeId">ns=1;s=<xsl:value-of select="$PDO"/>.t</xsl:attribute>
			<xsl:attribute name="BrowseName">1:<xsl:value-of select="$PDO"/>.t</xsl:attribute>
			<xsl:attribute name="DataType">String</xsl:attribute>
