...
@echo off
rem    %xslproc1% Example61850TestCID.xml XSCL2UANodeset3.xsl -o IEC_61850_CID_UANodeset3.xml
    %xslproc2% Example61850TestCID.xml XSCL2UANodesetTypes7.xsl > IEC_61850_CID_UANodesetTypes7.xml
rem    %xslproc3% Example61850TestCID.xml XSCL2UANodeset3.xsl IEC_61850_CID_UANodeset3.xml
